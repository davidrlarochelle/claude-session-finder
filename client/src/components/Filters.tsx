          ...
          >
            <label className="flex flex-col gap-1">
              ...
              <select
                ...
                value={model || ''}
                onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setModel(e.target.value || null)}
            ...
            <label className="flex flex-col gap-1">
              ...
              <select
                ...
                value={branch || ''}
                onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setBranch(e.target.value || null)}
                className="ui-input rounded-md border border-border px-2 py-1.5 text-sm text-fg"
              >
            ...
            <label className="flex cursor-pointer select-none items-center gap-2 text-fg-muted">
              <input
                ...
                checked={errorsOnly}
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setErrorsOnly(e.target.checked)}
